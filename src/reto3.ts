class Electrodomestico {
    ...
    color: string = "blanco";
    consumoEnergetico: string = "F";
    peso: number = 5;

    constructor(newPrecioBase: number, newColor: string, newConsumoEnergetico: string, newPeso: number) {
    ...
    comprobarConsumoEnergetico(consumo: string): string {
        ...
        let consumoValido = consumoLetra.find(
            (c) => c.toUpperCase() == consumo.toUpperCase()
        );
